        ...
        return (
            <div className= 'projects'>
                ...
                <div className='projects-section'>
                    ...
                    <a href ='https://mystifying-cray-69b25b.netlify.com/' target='_blank'>Deployed Site</a> <a href ='https://github.com/K0LdW0rLd/studio-ghibli' target='_blank'>GitHub Repo</a>
                </div>
                <div className='projects-section'>
                    ...
                    <a href ='https://studio-ghibli-970.herokuapp.com/studio' target='_blank'>Deployed Site</a> <a href ='https://github.com/K0LdW0rLd/studio-ghibli-api' target='_blank'>GitHub Repo</a>
                </div>
                <div className='projects-section'>
                    <h3>Trivia Game</h3>
                    ...
                    <a href ='https://serene-lamarr-d4da07.netlify.com/' target='_blank'>Deployed Site</a> <a href ='https://github.com/K0LdW0rLd/Trivia-Game' target='_blank'>GitHub Repo</a>
                </div>
            </div>
        )
    }
